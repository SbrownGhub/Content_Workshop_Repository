...
import { File, Video, Image, Trash2, Lock, Unlock, Play, BookOpen, Lightbulb, Zap, AlignHorizontalDistributeEndIcon } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-medium transition-all shadow-sm ${
                isAdmin ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800' : 'bg-white border-2 border-gray-300 text-gray-700 hover:border-gray-400'
              }`}
            >
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-all">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">3. Call-to-Action</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Tell them what to do next. No CTA = wasted opportunity. Be specific and make it frictionless. 
                Guide the next step.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-500 rounded-lg p-6">
            <div className="flex gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-2">Key Principle</p>
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-white shadow-xl">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            ...
            <p className="text-purple-100 text-sm mt-1">
              Perfect content posted is infinitely better than perfect content planned. Ship it, learn from it, improve it. 
